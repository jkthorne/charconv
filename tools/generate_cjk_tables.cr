...
#
# Output files:
#   src/iconvcr/tables/cjk_jis.cr    — JIS X 0208, JIS X 0212, JIS X 0201
#   src/iconvcr/tables/cjk_gb.cr     — GB2312, GBK ranges
#   src/iconvcr/tables/cjk_big5.cr   — Big5, Big5-HKSCS, CP950 extensions
#   src/iconvcr/tables/cjk_ksc.cr    — KSC 5601, CP949 extensions
...
def write_table_file(path : String, module_name : String, charsets : Array(CJKCharset))
  ...
  io.puts ""
  io.puts "module Iconvcr::Tables::#{module_name}"
...
base = File.join(__DIR__, "..", "src", "iconvcr", "tables")
