...
describe "CJK Encodings" do
  ...
  describe "EUC-JP" do
    it "converts Japanese text to UTF-8" do
      ...
      result = Iconvcr.convert(input, "EUC-JP", "UTF-8")
    ...
    it "round-trips through UTF-8" do
      ...
      euc_jp = Iconvcr.convert(utf8, "UTF-8", "EUC-JP")
      back = Iconvcr.convert(euc_jp, "EUC-JP", "UTF-8")
  ...
  describe "Shift_JIS" do
    it "converts Japanese text to UTF-8" do
      ...
      result = Iconvcr.convert(input, "SHIFT_JIS", "UTF-8")
  ...
  describe "CP932" do
    it "converts Japanese text to UTF-8" do
      input = Bytes[0x93, 0xFA, 0x96, 0x7B]
      result = Iconvcr.convert(input, "CP932", "UTF-8")
  ...
  describe "GBK" do
    it "converts Chinese text to UTF-8" do
      ...
      result = Iconvcr.convert(input, "GBK", "UTF-8")
    ...
    it "round-trips through UTF-8" do
      utf8 = "中文测试".to_slice
      gbk = Iconvcr.convert(utf8, "UTF-8", "GBK")
      back = Iconvcr.convert(gbk, "GBK", "UTF-8")
  ...
  describe "EUC-CN (GB2312)" do
    it "converts Chinese text to UTF-8" do
      input = Bytes[0xD6, 0xD0, 0xCE, 0xC4]
      result = Iconvcr.convert(input, "EUC-CN", "UTF-8")
  ...
  describe "GB18030" do
    it "converts 2-byte GBK-compatible text" do
      input = Bytes[0xD6, 0xD0, 0xCE, 0xC4]
      result = Iconvcr.convert(input, "GB18030", "UTF-8")
    ...
    it "round-trips supplementary plane characters" do
      ...
      gb = Iconvcr.convert(utf8, "UTF-8", "GB18030")
      back = Iconvcr.convert(gb, "GB18030", "UTF-8")
  ...
  describe "Big5" do
    it "converts Traditional Chinese to UTF-8" do
      ...
      result = Iconvcr.convert(input, "BIG5", "UTF-8")
  ...
  describe "CP950" do
    it "converts Traditional Chinese to UTF-8" do
      input = Bytes[0xA4, 0xA4, 0xA4, 0xE5]
      result = Iconvcr.convert(input, "CP950", "UTF-8")
  ...
  describe "EUC-KR" do
    it "converts Korean text to UTF-8" do
      ...
      result = Iconvcr.convert(input, "EUC-KR", "UTF-8")
    ...
    it "round-trips through UTF-8" do
      utf8 = "한글테스트".to_slice
      euckr = Iconvcr.convert(utf8, "UTF-8", "EUC-KR")
      back = Iconvcr.convert(euckr, "EUC-KR", "UTF-8")
  ...
  describe "CP949" do
    it "converts Korean text to UTF-8" do
      input = Bytes[0xC7, 0xD1, 0xB1, 0xDB]
      result = Iconvcr.convert(input, "CP949", "UTF-8")
  ...
  describe "ISO-2022-JP" do
    it "decodes ASCII mode" do
      input = "Hello".to_slice
      result = Iconvcr.convert(input, "ISO-2022-JP", "UTF-8")
      String.new(result).should eq("Hello")
    end
    ...
    it "round-trips Japanese text" do
      ...
      if iso
        back = Iconvcr.convert(iso, "ISO-2022-JP", "UTF-8")
  ...
  describe "HZ" do
    it "decodes ASCII text" do
      input = "Hello".to_slice
      result = Iconvcr.convert(input, "HZ", "UTF-8")
      String.new(result).should eq("Hello")
    end
    ...
    it "round-trips Chinese text" do
      ...
      if hz
        back = Iconvcr.convert(hz, "HZ", "UTF-8")
  ...
  describe "ISO-2022-KR" do
    it "round-trips Korean text via Iconvcr" do
      utf8 = "한글".to_slice
      iso = Iconvcr.convert(utf8, "UTF-8", "ISO-2022-KR")
      back = Iconvcr.convert(iso, "ISO-2022-KR", "UTF-8")
    ...
    it "decodes known ISO-2022-KR sequence" do
      ...
      result = Iconvcr.convert(input, "ISO-2022-KR", "UTF-8")
  ...
  CJK_TEST_ENCODINGS.each do |encoding, test_inputs|
    test_inputs.each_with_index do |input, idx|
      it "#{encoding} sample #{idx} matches system iconv" do
        ...
        result = Iconvcr.convert(input, encoding, "UTF-8")
